#!/usr/bin/env python3
"""
Script to create a new themes.py file with:
1. Old LCARS themes (DS9, Voy, TNG-E) removed from all sections
2. Continue using the existing built-in themes from CSS files rather than database themes
3. Let database themes be loaded separately as custom themes
"""

def create_updated_themes_api():
    """Create an updated themes.py with old themes removed"""
...
'''
    ...
    # Write the new themes.py file
    with open('/home/mike/mvidarr/src/api/themes.py', 'w') as f:
        f.write(themes_api_content)
    
    print("Created new themes.py file with old LCARS themes removed")

if __name__ == "__main__":
    create_updated_themes_api()