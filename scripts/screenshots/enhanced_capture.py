#!/usr/bin/env python3
"""
MVidarr Enhanced - Advanced Screenshot Capture
...
class EnhancedScreenshotCapture:
    ...
    async def check_application_health(self) -> bool:
        """Check if MVidarr Enhanced is running and responsive"""
        try:
    ...
    async def capture_all_screenshots(self, priority: str = None, limit: int = None) -> Dict[str, int]:
        ...
        if not await self.check_application_health():
            self.logger.error(f"❌ MVidarr Enhanced is not accessible at {self.base_url}")
    ...
    def create_capture_report(self, results: Dict[str, int]) -> str:
        ...
        report = f"""# MVidarr Enhanced Screenshot Capture Report
...
1. Ensure MVidarr Enhanced is fully loaded with sample data
...
---
*Generated by MVidarr Enhanced Screenshot Capture Tool*
"""
