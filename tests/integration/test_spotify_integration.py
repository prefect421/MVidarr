...
from src.services.spotify_sync_service import spotify_sync_service, SyncResult
...
class TestSpotifyIntegration:
    ...
    def test_track_similarity_calculation(self):
        ...
        # Partial match
        similarity = sync_service._calculate_track_similarity("Test Song", "Test Song (Official Video)")
        assert similarity > 0.7
        
        # No match
        similarity = sync_service._calculate_track_similarity("Test Song", "Completely Different")
    ...
    def test_music_video_recommendations(self, mock_db):
        ...
        with patch.object(spotify_service, 'get_user_top_tracks') as mock_top_tracks:
            ...
            with patch.object(spotify_service, 'get_recommendations') as mock_recommendations:
                mock_recommendations.return_value = {"tracks": []}
