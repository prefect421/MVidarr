...
class DynamicAuthMiddleware:
    ...
    def register_auth_routes(self, app):
        ...
        def simple_login_page():
            ...
            logger.info(f"Simple login page accessed - IP: {client_ip}, Authenticated: {is_authenticated}")
        ...
        def simple_login():
            ...
            try:
                ...
                if username == 'admin' and password == 'MVidarr@dmin123':
                    ...
                    logger.info(f"Session contents after login: {dict(session)}")  # Temporarily change to INFO level
                    ...
                    if request.is_json:
                        ...
                        return redirect(url_for('simple_login_page', error='Invalid credentials'))
        ...
        def test_session():
            ...
            try:
                ...
                logger.info(f"Response cookies will be set: {response.headers.get('Set-Cookie', 'NONE')}")
        ...
        def change_password():
            ...
            try:
                ...
                logger.info(f"Password change request for user {username} (not implemented)")
    ...
    def check_authentication_requirement(self):
        ...
        try:
            ...
            if not is_authenticated:
                ...
                logger.info(f"Authentication required: redirecting unauthenticated request from {request.path}")
