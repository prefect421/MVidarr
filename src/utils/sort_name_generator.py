...
class SortNameGenerator:
    ...
    SPECIAL_CHARS_PATTERN = re.compile(r'[""''`]')  # Remove curly quotes and backticks, but preserve apostrophes
    ...
    @classmethod
    def ensure_sort_name(cls, artist_name: str, current_sort_name: Optional[str] = None) -> str:
        """
