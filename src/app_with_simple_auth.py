...
def create_app():
    ...
    def before_request():
        ...
        g.current_user = SimpleAuthService.get_current_username() if g.require_auth else 'anonymous'
        g.is_authenticated = SimpleAuthService.is_authenticated() if g.require_auth else True
