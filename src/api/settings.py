...
def restart_application():
    ...
    try:
        ...
        return jsonify({'message': 'Application restart initiated. Please wait 10-15 seconds and refresh the page.'}), 200
...
def restart_systemd_service():
    ...
    try:
        ...
        return jsonify({'message': 'Emergency systemd restart initiated. Service will restart shortly.'}), 200
...
def reload_scheduler():
    ...
    try:
        ...
        return jsonify({'message': 'Scheduler configuration reloaded successfully'}), 200
