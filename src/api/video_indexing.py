...
def index_all_videos():
    ...
    try:
        ...
        logger.info(f"Starting video indexing process (fetch_metadata={fetch_metadata}, max_files={max_files})")
...
def preview_indexing():
    ...
    try:
        ...
        if (file_metadata.get('extracted_artist') and 
            file_metadata.get('extracted_title')):
