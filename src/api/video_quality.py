...
def set_quality_preferences():
    ...
    try:
        ...
        success = video_quality_service.set_user_quality_preferences(preferences, user_id)
...
def get_ytdlp_format_string():
    ...
    try:
        ...
        format_string = video_quality_service.generate_ytdlp_format_string(user_id, artist_id)
...
def find_upgradeable_videos():
    ...
    try:
        ...
        upgradeable_videos = video_quality_service.find_upgradeable_videos(user_id, limit)
...
def set_artist_quality_preferences(artist_id):
    ...
    try:
        ...
        preferences = data["preferences"]
        success = video_quality_service.set_artist_quality_preferences(artist_id, preferences)
    ...
    try:
        ...
        for level in QualityLevel:
            quality_levels.append({
                ...
                "description": f"{level.value} ({level.to_height()}p)" if level.value != "best" else "Best Available"
            })
