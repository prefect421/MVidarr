...
youtube_playlists_bp = Blueprint(
    "youtube_playlists", __name__, url_prefix="/youtube/playlists"
)
...
def get_monitored_playlists():
    ...
    try:
        ...
        return jsonify({"playlists": playlists, "count": len(playlists)}), 200
...
def extract_playlist_id():
    ...
    try:
        ...
        return jsonify({"playlist_id": playlist_id, "valid": True}), 200
...
def get_playlist_info():
    ...
    try:
        ...
        return jsonify({"playlist_info": playlist_info, "valid": True}), 200
