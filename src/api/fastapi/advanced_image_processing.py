...
async def bulk_image_analysis(
    ...
    try:
        ...
        logger.info(f"✅ Bulk analysis completed: {successful}/{len(metadata_list)} successful")
        return response
...
async def convert_image_formats(
    ...
    try:
        ...
        logger.info(f"🔄 Converting {len(source_paths)} images to {len(request.target_formats)} formats")
        ...
        logger.info(f"✅ Format conversion completed: {successful}/{len(results)} successful")
        return response
...
async def enhance_image_quality(
    ...
    try:
        ...
        logger.info(f"✅ Quality enhancement completed: {successful}/{len(results)} successful")
        return response
