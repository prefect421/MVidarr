...
from flask import Blueprint, request, jsonify, session as flask_session, redirect, url_for, render_template
...
from src.services.audit_service import AuditService, AuditEventType, log_login_success, log_login_failed, log_logout, log_oauth_login_success, log_oauth_login_failed
    ...
    try:
        ...
        if success and user_data:
            ...
            if requires_2fa:
                ...
                flask_session['temp_login_time'] = user_data['last_login'].isoformat() if user_data['last_login'] else None
...
def oauth_login(provider):
    ...
    try:
        ...
        if success:
            ...
            log_oauth_login_failed(provider, auth_url)  # auth_url contains error message
