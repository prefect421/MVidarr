...
from src.database.models import Setting, Artist, Video, Download, User, TaskQueue
...
def init_default_settings():
    ...
    default_settings = [
        ...
        ('auto_organize_downloads', 'true', 'Automatically organize downloads by artist'),
        ...
        ('require_authentication', 'false', 'Require user login to access the application'),
        ('auto_download_schedule_enabled', 'false', 'Enable scheduled automatic downloads'),
        ('auto_download_schedule_time', '02:00', 'Time to run automatic downloads (HH:MM format)'),
        ('auto_download_schedule_days', 'daily', 'Schedule frequency: daily, weekly, or specific days'),
        ('auto_download_max_videos', '50', 'Maximum videos to download per scheduled run'),
        ('spotify_client_id', '', 'Spotify application client ID'),
        ('spotify_client_secret', '', 'Spotify application client secret'),
        ('spotify_redirect_uri', 'http://127.0.0.1:5000/api/spotify/callback', 'Spotify OAuth redirect URI'),
    ]
...
def check_database_health():
    ...
    try:
        ...
        with engine.connect() as connection:
            ...
            tables = ['settings', 'artists', 'videos', 'downloads', 'users', 'task_queue']
            for table in tables:
