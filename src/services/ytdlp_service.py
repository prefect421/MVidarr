                    ...
                    if status == "DOWNLOADED":
                        ...
                        if file_path and os.path.exists(file_path):
                            ...
                            try:
                                ...
                                logger.info(f"Extracting FFmpeg metadata for newly downloaded video {video_id}")
                                ...
                                if ffmpeg_metadata.get("duration") and not video.duration:
                                    ...
                                    logger.info(f"Updated video {video_id} duration: {video.duration}s")
                                    
                                if ffmpeg_metadata.get("quality") and not video.quality:
                                    video.quality = ffmpeg_metadata["quality"]
                                    logger.info(f"Updated video {video_id} quality: {video.quality}")
                                ...
                                if ffmpeg_metadata.get("width") or ffmpeg_metadata.get("height"):
                                    ...
                                    logger.info(f"Updated video {video_id} with technical metadata from FFmpeg")
