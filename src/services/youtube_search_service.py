...
class YouTubeSearchService:
        ...
        try:
            ...
            for item in data.get('items', []):
                ...
                video_info = {
                    ...
                    'search_score': self._calculate_relevance_score(snippet.get('title', ''), artist_name)
                }
    ...
    def _calculate_relevance_score(self, title: str, artist_name: str) -> float:
        ...
        music_indicators = ['music video', 'official video', 'official music video', 'mv', 'clip']
    ...
    def search_video_by_title(self, title: str, artist_name: str = None, limit: int = 10) -> Dict:
        ...
        try:
            ...
            for item in data.get('items', []):
                ...
                video_info = {
                    ...
                    'tags': details.get('tags', []),
                    'source': 'youtube_search',
                    'search_score': self._calculate_title_match_score(snippet.get('title', ''), title, artist_name)
                }
    ...
    def _calculate_title_match_score(self, video_title: str, search_title: str, artist_name: str = None) -> float:
    ...
    def search_artist_channel_thumbnail(self, artist_name: str) -> Optional[str]:
        ...
        if not self.api_key:
            logger.warning("YouTube API key not configured, skipping YouTube channel search")
            return None
        ...
        try:
            ...
            for item in data.get('items', []):
                ...
                if (artist_name_lower in channel_title or 
                    any(word in channel_title for word in artist_name_lower.split() if len(word) > 2)):
                    ...
                    if thumbnails:
                        ...
                        if thumbnail_url:
                            logger.info(f"Found YouTube channel thumbnail for {artist_name}: {thumbnail_url}")
