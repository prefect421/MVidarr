...
class SettingsService:
    ...
    def get_int(cls, key: str, default: int = 0) -> int:
        ...
        try:
            ...
            logger.warning(f"Setting '{key}' value '{value}' is not a valid integer, using default {default}")
            return default
    ...
    def get_float(cls, key: str, default: float = 0.0) -> float:
        ...
        try:
            ...
            logger.warning(f"Setting '{key}' value '{value}' is not a valid float, using default {default}")
            return default
